<div role='main' class='home container-fluid'>
    ...
    <div class='mt-4 p-2 text-black text-center'>
        ...
        <p class='p-4 font-md'>We offer a fully equipped commercial kitchen, modern and versatile event space, business
            support, and a network of like-minded culinary creatives.</p>
    </div>
