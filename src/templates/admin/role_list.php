...
if ($this->data)
{
    foreach ($this->data as $i => $row)
    {
        ...
        $tr .= "<tr>
            ...
            <td class='text-right'><a class='btn btn-primary btn-xs' href='/admin/role/edit/{$row->id}'>Edit</a></td>
        </tr>";
    }
}
?>
<div role='main' class='container'>
    <div class='mt-4 text-left'>
        <a class='btn btn-primary' href="role/0" alt="Add New Role" title="Add New Role">New</a>
    </div>
    <div class='mt-4 p-2 bg-secondary text-white text-center rounded shadow'>
        <h3>Administration: Role listing</h3>
    </div>
