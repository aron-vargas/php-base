...
<div class='container'>
    ...
    <div class='pt-3'>
        ...
        <p>
            ...
            you'll need to become a Member and block out your needed time slot.
            The first step in the process is for you to fill out this Membership Inquiry
            <a href='/membership/signup-form'>form</a>.
            Once your submission has been reviewed,
            we'll reach out to discuss your requirements and kitchen needs.
            Our available space is limited and is subject to seasonal pressures,
            so important to get in early to make sure time is secured.
            It usually takes a few weeks for all the necessary pieces to come together,
            so give yourself plenty of time to complete the checklist below.
            Membership is limited and depends on availability.
    ...
    <div class='pt-1'>
        ...
        <p>Once those documents are on file, Members can reserve kitchen time
    ...
    <div class='pt-3'>
        ...
        <p class='mb-2'>Railside Kitchen charges an hourly rate for kitchen time,
            ...
            The minimum level of Membership we offer is the Basic Level,
            which allows for 20 hours of kitchen time during peak hours.
            There is an additional monthly rate for cold, freezer, and dry storage.
            We also offer parking for food trucks and trailers.
            We offer 6-month or 12-month Membership contracts.
    ...
    <div class='pt-3'>
        ...
        <p class='mb-2'>If your business is dependent on specialty equipment
            ...
            feel free to reach out to see if we can accomodate
            your equipment, have the space to store it,
            and what the monthly storage costs would be.
            You may bring in your own specialty smallwares
            to store on your rental storage racks.
    ...
    <div class='pt-3'>
        ...
        <p class='mb-2'>Depending on your requirements, we can
            ...
            We will prioritize with scheduling for our current
            Members who have committed to monthly usage in our
            shared kitchen and have a health permit to operate out of our facility.
            However, if you are an established business with an
            existing health permit, insurance, and are
            Food Safety Manager certified; then we can begin to
            discuss our policies towards Occasional-Use
            Clients and see if our current kitchen
            availability will meet your needs.
            Occasional-Use Clients will be required to provide
            the same documents as regular Members.
            <span class='todo'>
