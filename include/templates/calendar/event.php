...
$check_all_day = ($event->all_day) ? "checked" : "";
                ...
                <div id='event-modal-body' class='modal-body'>
                    ...
                    <div class="form-group>
                        ...
                        <div class='form-check">
                            <input type='radion' id="private_y" name="private" class="form-check-input" value=1>
                            <label class="form-check-label" for="private_y">Private</label>
                            &nbsp;
                            <input type='radion' id="private_n" name="private" class="form-check-input" value=0>
